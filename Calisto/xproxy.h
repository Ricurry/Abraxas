...
/**
* x-proxy; Traffic Redirect URL.
* URL's are authorized using fletcher's checksum.
* TODO: Implement posix-threading.
*/
...
void netlink::auth(void * threadid) 
{
    ...
    int socket = netstat->socket;
    // set socket parameters to intercept avaliable connections.
}